...
import "../external/fractional/OpenZeppelin/access/Ownable.sol";
import "../external/fractional/OpenZeppelin/utils/Pausable.sol";

import "../external/fractional/OpenZeppelin/token/ERC721/ERC721.sol";
import "../external/fractional/OpenZeppelin/token/ERC721/ERC721Holder.sol";

import {InitializedProxy} from "../InitializedProxy.sol";
import "../external/fractional/Settings.sol";
import "./MockERC721TokenVault.sol";

contract MockERC721VaultFactory is Ownable, Pausable {
  ...
  constructor(address _settings) {
    settings = _settings;
    logic = address(new MockTokenVault(_settings));
  }
