...
describe('Bid: Emergency Force Lost', async () => {
            ...
            testCases.map((testCase, i) => {
                describe(`Case ${i}`, async () => {
                    ...
                    it('Does not allow non-multisig to force lost', async () => {
                        await expect(emergencyForceLost(partyBid, signers[1])).to.be.reverted;
                        await expect(emergencyForceLost(partyBid, signers[2])).to.be.reverted;
                    });
                    ...
                    it(`Did not transfer fee to multisig`, async () => {
                        ...
                        expect(parseFloat(multisigBalanceAfter)).to.be.lessThan(parseFloat(multisigBalanceBefore));
                    });
